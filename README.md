...
The backend is proudly hosted and running live on **Render**. You can explore the API and its documentation using the links below:
- **Base API URL**: [https://kbinge-backend.onrender.com/](https://kbinge-backend.onrender.com/)
- **Swagger Documentation**: [https://kbinge-backend.onrender.com/api-docs](https://kbinge-backend.onrender.com/api-docs)
## 🚀 Tech Stack
